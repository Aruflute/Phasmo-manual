...
def before_is_location_enabled(multiworld: MultiWorld, player: int, location:  dict[str, Any]) -> Optional[bool]:
    ...
    # selected_goal is 0–4 (based on YAML order)
    max_chapter = selected_goal  # perfect 1:1 mapping

    if "Apoc III" in categories and max_chapter < 2:
        return False
    if "Apoc II" in categories and max_chapter < 1:
        return False
    return None
